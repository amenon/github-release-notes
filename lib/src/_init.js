...
const getQuestions = async() => {
    ...
    return [
        ...
        {
            name: 'deleteReleaseWithTags',
            type: 'confirm',
            default: false,
            message: 'Do you want to delete certain tags?'
        },
        {
            name: 'deleteReleaseWithTags',
            type: 'input',
            message: 'Which ones? Use commas to separate',
            suffix: chalk.blueBright(' e.g. latest'),
            filter: value => value.replace(/\s/g).split(','),
            when: ({ deleteReleaseWithTags }) => deleteReleaseWithTags
        },
        {
